...
if ($str_language == 'de'): ?>
		...
		<p class="text">
			Server-Name: <samp><?
    echo $_SERVER['SERVER_NAME']; ?></samp><br />
			Document-Root: <samp><?
    echo $_SERVER['DOCUMENT_ROOT']; ?></samp>
		</p>
		<p class="text" id="footnote_1"><small><sup>1</sup> Dateien: <samp>index.php</samp> und <samp>MAMP-PRO-Logo.gif</samp></small></p>
		<hr />
		<p class="text">Diese Seite in: <?
    echo $str_available_languages; ?></p>
	<?
elseif ($str_language == 'en'): ?>
